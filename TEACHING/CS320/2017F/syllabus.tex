...
\begin{itemize}
\item
{\em A Functional Crash into ATS} by Hongwei Xi, which is available at:
\begin%
{center}
\texttt{http://www.ats-lang.org/Documents.html\#ATS2FUNCRASH0}
\end{center}
\item
{\em Introduction to Programming in ATS} by Hongwei Xi, which is available at:
\begin%
{center}
\texttt{http://www.ats-lang.org/Documents.html\#INT2PROGINATS}
\end{center}
\end{itemize}
